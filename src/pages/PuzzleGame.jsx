...
const PuzzleGame = () => {
  ...
  const [isMultiplayer, setIsMultiplayer] = useState(false); // Multiplayer flag
  ...
  const handleVerify = () => {
    ...
    if (matchedWord && !currentLockedWords.includes(matchedWord)) {
      ...
      console.log('Player 1 Words Found:', player1WordsFound); // Debugging
      console.log('Player 2 Words Found:', player2WordsFound); // Debugging
      ...
      // If word is incorrect or already selected, reset the selection
